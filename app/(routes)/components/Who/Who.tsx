...
export default memo(function Who({
  title = "Landing Page Background",
}: {
  title?: string;
}) {
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-[#f7f7f7] dark:bg-neutral-950">
